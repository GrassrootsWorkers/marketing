 ...
 *
 */
package com.yao.marketing.string;
...
public final class StringUtil {
	 ...
	 * @return 拆分后的数组列表
	 */
	public static List<String> splitStrToList(String pattern, String aStr) {
	...
	public static String generateString(int length) {
		...
		for (int i = 0; i < length; i++) {
			...
			sb.append("ABCDEFGHIJKLMNOPQRSTUVWXYZ".charAt(random
					.nextInt("ABCDEFGHIJKLMNOPQRSTUVWXYZ".length())));
		}
		return sb.toString();
	}

		public  static Map<String,Object> parseStrToMap(String source, String separator1, String separator2){
				Map<String,Object> result = new HashMap<String,Object>();
				String[] strs = source.split(separator1);
				for(String str: strs){
						String[] keyValue = str.split(separator2);
